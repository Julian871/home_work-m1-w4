...
export const getSortUsersQuery = (sortBy: string | undefined, sortDirection: string | undefined, searchLoginTerm: string | null, searchEmailTerm: string | null): {sortBy: string, sortDirection: 1 | -1, searchLoginTerm: string | null, searchEmailTerm: string | null} =>{
    return {
